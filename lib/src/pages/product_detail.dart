...
class _ProductDetailPageState extends State<ProductDetailPage>
  ...
  Widget _appBar(BuildContext context) {
    Product model = ModalRoute.of(context).settings.arguments;
    isLiked = context.watch<AppData>().isProductLiked(model);
    return Container(
  ...
  FloatingActionButton _flotingButton(BuildContext context) {
    Product model = ModalRoute.of(context).settings.arguments;
    return FloatingActionButton(
      onPressed: () {
        print('clicked');
        context.read<AppData>().addToCart(model);
